...
#-*- coding:utf-8 -*-
"""
Parse HMMsearch table output and generate a CSV file of TAP domain counts for
each species.
...
def main():
    ...
    write_counts_csv(recarrays, '../output/tap_domain_frequencies.csv')
