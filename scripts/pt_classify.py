...
def init_classification_rules():
    ...
    return [
        ...
        ProteinFamily("Dicer", "TF", ["DEAD", "Helicase_C", "Ribonuclease_3", "dsrm"], ["Piwi"]),
        ProteinFamily("DUF246 domain containing", "TF", ["DUF246"]),
        ProteinFamily("DUF296 domain containing", "TF", ["DUF296"]),
        ProteinFamily("DUF547 domain containing", "TF", ["DUF547"]),
        ProteinFamily("DUF632 domain containing", "TF", ["DUF632"]),
        ProteinFamily("DUF833 domain containing", "TF", ["DUF833"]),
        ...
        ProteinFamily("GIF", "TF", ["SSXT"]),
        ProteinFamily("GNAT", "TF", ["Acetyltransf_1"], ["PHD"]),
        ...
        ProteinFamily("HMG", "TF", ["HMG_box"], ["ARID", "YABBY"]),
        ProteinFamily("HRT", "TF", ["HRT"]),
        ProteinFamily("HSF", "TF", ["HSF_DNA-bind"]),
        ProteinFamily("IWS1", "TF", ["IWS1_C"], []),
        ProteinFamily("Jumonji", "TF", ["JmjC", "JmjN"], ["ARID", "GATA", "zf-C2H2", "Alfin-like"]),
        ProteinFamily("LFY", "TF", ["FLO_LFY"]),
        ProteinFamily("LIM", "TF", ["two_or_more_LIM"]),
        ProteinFamily("LUG", "TF", ["LUFS_Domain"]),
        ProteinFamily("MADS", "TF", ["SRF-TF"]),
        ProteinFamily("MBF1", "TF", ["MBF1"]),
        ProteinFamily("MED6", "TF", ["MED6"]),
        ProteinFamily("MED7", "TF", ["MED7"]),
        ...
        ProteinFamily("OFP", "TF", ["DUF623"]),
        ProteinFamily("PcG_EZ", "TF", ["SANTA", "SET"]),
        ProteinFamily("PcG_FIE", "TF", ["FIE_clipped_for_HMM", "WD40"]),
        ProteinFamily("PcG_VEGS", "TF", ["VEGS-Box"], ["zf-C2H2"]),
        ProteinFamily("PHD", "TF", ["PHD"], ["Myb_DNA-binding", "Alfin-like", "ARID", "DDT", "Homeobox", "JmjC", "JmjN", "SWIB", "zf-TAZ", "zf-MIZ", "zf-CCCH"]),
        ProteinFamily("PLATZ", "TF", ["PLATZ"]),
        ProteinFamily("Pseudo ARR-B", "TF", ["CCT", "Response_reg"], ["tify"]),
        ProteinFamily("RB", "TF", ["RB_B"]),
        ProteinFamily("Rcd1-like", "TF", ["Rcd1"]),
        ProteinFamily("Rel", "TF", ["RHD"]),
        ProteinFamily("RF-X", "TF", ["RFX_DNA_binding"]),
        ProteinFamily("RRN3", "TF", ["RRN3"]),
        ...
        ProteinFamily("SET", "TF", ["SET"], ["zf-C2H2", "CXC", "PHD", "Myb_DNA-binding"]),
        ProteinFamily("Sigma70-like", "TF", ["Sigma70_r2", "Sigma70_r3", "Sigma70_r4"]),
        ProteinFamily("Sin3", "TF", ["PAH"], ["WRKY"]),
        ProteinFamily("Sir2", "TF", ["SIR2"]),
        ProteinFamily("SOH1", "TF", ["SOH1"]),
        ProteinFamily("SRS", "TF", ["DUF702"]),
        ProteinFamily("SWI/SNF_BAF60b", "TF", ["SWIB"]),
        ProteinFamily("SWI/SNF_SNF2", "TF", ["SNF2_N"], ["AP2", "PHD", "zf_CCCH", "Myb_DNA-binding"]),
        ProteinFamily("SWI/SNF_SWI3", "TF", ["SWIRM"], ["Myb_DNA-binding"]),
        ProteinFamily("TAZ", "TF", ["zf-TAZ"]),
        ProteinFamily("TCP", "TF", ["TCP"]),
        ProteinFamily("TEA", "TF", ["TEA"]),
        ProteinFamily("TFb2", "TF", ["Tfb2"]),
        ProteinFamily("tify", "TF", ["tify"]),
        ProteinFamily("TRAF", "TF", ["BTB"], ["zf-TAZ"]),
        ...
        ProteinFamily("Zinc_finger, AN1 and A20 type", "TF", ["zf-AN1"], ["zf-C2H2"]),
        ProteinFamily("Zinc finger, MIZ type", "TF", ["zf-MIZ"], ["zf-C2H2"]),
        ProteinFamily("Zinc finger, ZPR1", "TF", ["zf-ZPR1"]),
